    ...
    <>
        ...
        <div className="space-y-6">
          ...
          <div>
            <h3 className="text-sm font-bold text-white/80 mb-3 flex items-center gap-2">
              <Icon name="sparkles" size={14} strokeWidth={2} className="text-gold" />
              Appearance
            </h3>
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 rounded-xl bg-white/[0.03] border border-white/[0.06]">
                <div>
                  ...
                  <p className="text-xs text-white/40 mt-0.5">Choose your display theme</p>
                </div>
          ...
          <div>
            <h3 className="text-sm font-bold text-white/80 mb-3 flex items-center gap-2">
              <Icon name="globe" size={14} strokeWidth={2} className="text-brand-blue-light" />
              Network
            </h3>
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 rounded-xl bg-white/[0.03] border border-white/[0.06]">
                <div>
                  <p className="text-sm font-semibold text-white">Blockchain Network</p>
              ...
              {network === 'mainnet' && (
                <div className="flex items-start gap-2 p-3 rounded-xl bg-error/10 border border-error/20">
                  <Icon name="alert" size={16} strokeWidth={2} className="text-error flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="text-xs font-semibold text-error">Mainnet Active</p>
          ...
          <div>
            <h3 className="text-sm font-bold text-white/80 mb-3 flex items-center gap-2">
              <Icon name="info" size={14} strokeWidth={2} className="text-white/40" />
              About
            </h3>
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between p-3 rounded-xl bg-white/[0.03]">
                ...
                <p className="text-xs font-mono text-white/70 capitalize">{network}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        footer={
          <>
            ...
            <button
              ...
              className="px-4 py-2 rounded-lg text-sm font-semibold bg-error/90 text-white hover:bg-error transition-colors flex items-center gap-1.5"
            >
      ...
      >
        <div className="flex items-start gap-3">
          <span className="w-10 h-10 rounded-xl bg-error/10 border border-error/20 text-error flex items-center justify-center flex-shrink-0">
            <Icon name="alert" size={20} strokeWidth={2} />
          </span>
          <div className="space-y-3">
            <p className="text-sm text-white/70 leading-relaxed">
              Switching to mainnet means you'll be using <strong className="text-white">real NIM</strong> and making <strong className="text-white">real transactions</strong> that cannot be undone.
            </p>
